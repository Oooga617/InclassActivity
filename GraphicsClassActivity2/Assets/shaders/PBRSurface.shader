Shader "Custom/PBRSurface"
{
     Properties
    {
        ...
        _Smoothness("Smoothness", Range(-1.0, 10.0)) = 0.5 // Smoothness property
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float4 _SpecColor;            // Color property
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 specular = _SpecColor.rgb*pow(NdotH, _Smoothness);
